...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Selected Starter: Hand-Crafted Bespoke](./starter-template-evaluation.md#selected-starter-hand-crafted-bespoke)
  - [Core Architectural Decisions](./core-architectural-decisions.md)
    ...
    - [Testing Approach](./core-architectural-decisions.md#testing-approach)
  ...
  - [Project Structure & Boundaries](./project-structure-boundaries.md)
    ...
    - [ Internal Structure](./project-structure-boundaries.md#internal-structure)
    - [ Internal Structure](./project-structure-boundaries.md#internal-structure)
    - [ Internal Structure](./project-structure-boundaries.md#internal-structure)
